    ...
    myReset.addEventListener('click', function(){
        myText.innerHTML = "..........."
        myImage.src = "https://img.freepik.com/vrije-photo/reset-drukknop_165073-672.jpg?size=626&ext=jpg"
    })
    ...
    function sayItLoud (textString) {
      ...
      message.pitch = randomizer(0, 2); // range between 0 and 2
      message.rate = randomizer(1, 10); // range between 0.1 (lowest) and 10 (highest) 
      window.speechSynthesis.speak(message);
    }
    
    
    
    const onderwerp = ["he", "Becky", "Gerrit"];
    const werkwoord = ["runs", "reads", "eats"];
    const restwoord = ["at their own pace", "at school", "bread"];
